  ...
  return (
    <Background>
      ...
      <Container>
        ...
        <Imagem source={require('../../../../assets/leader/otimo.jpg')} />
        <Titulo>Você tem uma ótima competência em Liderança. Sabe como se portar e auxiliar aos demais.</Titulo>
        <View style={{flexDirection:'row', justifyContent:'center', alignItems:'flex-end', backgroundColor:'#5402a1', height:40, marginTop:125}}>
