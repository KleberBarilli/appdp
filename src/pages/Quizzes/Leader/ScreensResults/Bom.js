...
export default function Bom() {
  ...
  return (
    <Background>
      ...
      <Container>
        <Titulo>BOA!!!</Titulo>
        <Imagem source={require('../../../../assets/leader/bom.jpg')} />
        <Titulo>Você vai indo bem, mas pode melhorar em vários pontos. Veja as questões onde deveria ter pontuado mais. Elas lhe dirão quais itens requerem melhoria.</Titulo>
        <View style={{flexDirection:'row', justifyContent:'center', alignItems:'flex-end', backgroundColor:'#5402a1', height:40, marginTop:60}}>
